"""Vision backbone for Qwen2.5-VL.

This module keeps all vision-specific building blocks isolated from the text
model so the multimodal pipeline remains easy to reason about.

Help from https://github.com/huggingface/transformers/blob/caa14e7dabb086f167c14b7eecadc2ba9db25eb6/src/transformers/models/qwen2_5_vl/modular_qwen2_5_vl.py
"""
...
class VisionPatchMerger(nn.Module):
    ...
    def setup(self) -> None:
        ...
        self.norm = RMSNorm(self.context_dim, 1e-6, self.dtype)
...
__all__ = ["Qwen25VisionTransformer"]
